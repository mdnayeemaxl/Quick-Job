...
<?php
function validation($type,$email){
        ...
        if(!empty($fname)&&!empty($mail)&&!empty($password)&&!empty($cpassword)&&!empty($date) && ($c1==1)&& ($c2==1)&& ($c3==1)&& ($c4==1))
            {
                if($act=='Employer')
                    {
                        $sql="INSERT INTO employer (name,email,password,dob,gender,image) VALUES ('$fname','$mail','$password','$date','$gen','later') ";
                    }
                else
                    {
                        $sql="INSERT INTO jobseeker (name,email,password,dob,gender,image) VALUES ('$fname','$mail','$password','$date','$gen','later') ";
                    }
		...
		<div class="row" >
			<div class="offset-lg-1 col-lg-10" >
                <?php
                    ...
                    echo success();
                ?>
				<form class="" action="signup.php" method="post">                                              <?php//////////////////////////////////////?>
