...
?>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <?php
                            ...
                            $ad='<li class="nav-item">'.' <a class="nav-link"'.'href="admin_post_view.php">Admin</a></li>';
    ...
    <div class="container">
            ...
            <div>
                ...
                <?php 
                            if($eid=='employer'){
                                $sql="SELECT * FROM employer WHERE id ='$y'";
                                $folder='employer/';
                            }
                            else if($eid=='jobseeker'){
                                $sql="SELECT * FROM jobseeker WHERE id ='$y'";
                                $folder='jobseeker/';
                            }
