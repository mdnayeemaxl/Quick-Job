...
JOB PORTAL</p></a>
    ...
    <section  class="container py-2 mb-4">
        <div class="row" style="min-height:30px;">
            ...
            <?php
                $sid=$_SESSION["seekuserid"];
                $count=0;
                $sql="SELECT j.category,j.title,j.salary,j.jobdescription,a.status FROM apply a CROSS JOIN jobpost j WHERE a.postid=j.id AND a.skid='$sid'";
